...
<script>
	...
	var UpgradeList<?php echo $AbleToUpgrade[$i][0] ?> = new Array();
		<?php for ($j=0;$j<=$UpgradesListSize[$i];$j++): ?>
			UpgradeList<?php echo $AbleToUpgrade[$i][0] ?>.push(Array('<?php echo $UpgradeList[$i][$j][0] ?>','<?php echo $UpgradeList[$i][$j][1] ?>','<?php echo $UpgradeList[$i][$j][2] ?>','<?php echo $UpgradeList[$i][$j][3] ?>','<?php echo $UpgradeList[$i][$j][4] ?>','<?php echo $UpgradeList[$i][$j][5] ?>'));
		<?php endfor; ?>
	<?php endfor; ?>
</script>
